...
7. **Section reorder from Settings** — `SectionKey` and per-domain section order exist in the data model plan but renderers hard-code the order; make both renderers consume a shared ordered section list.
